...
# Tidying Race/Ethnicity Categories
...
# Update race3 categories - separate race and ethnicity
...
# The function returns 1 for pass, 0 for fail
if(qa_result == 1) {
  message("QA checks passed successfully!")
} else {
  message("QA checks failed. Please review your data and calculations.")
}
```
...
chi_sql_update(CHIestimates = myestimates,
               CHImetadata = mymetadata,
...
-   `chi_sql_update()` to save estimates and metadata to SQL Server
